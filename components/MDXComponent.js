...
const MDXComponents = () => {
  ...
  return {
    ...
    h2: (props) => (
      <Heading fontWeight="bold" as="h3" size="lg" my="15px" {...props} />
    ),
    h3: (props) => (
      <Heading fontWeight="bold" as="h4" size="md" my="15px" {...props} />
    ),
    h4: (props) => (
      <Heading fontWeight="bold" as="h5" size="sm" my="15px" {...props} />
    ),
    strong: (props) => <Text as="strong" fontWeight="bold" {...props} />,
    code: (props) => {
      return (
        <Container position="relative">
          <Text bg="orange" position="absolute" top="-8px" left="30px">
            {props.className}
          </Text>
          <CopyToClipboard
            text={props.children}
