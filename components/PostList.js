import { HStack, VStack, Text, Avatar, Box, Divider, Tag } from "@chakra-ui/react";
...
export default function PostList({ post }) {
  ...
  return (
    <HStack border="1px" borderColor="gray.200" borderRadius="5px" p={2} w="100%" justifyContent="space-between">
      <HStack >
